...
const FlightDetails: React.FC<Props> = ({ data }) => {
  ...
  // Ensure data and data.data are available before destructure
  if (!data || !data.data) {
    return null;
  }
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg-px-8 my-10 z-">
          <div className="grid grid-cols-3 gap-10">
            ...
            <div className="mx-2 my-16 col-span-2 bg-[#bae1d6] shadow-lg rounded-lg overflow-hidden ">
              ...
              <div className="px-6 py-4 flex justify-between">
                ...
                <div className="flex flex-col gap-y-5">
                  <div>
                    ...
                    <h3 className="text-[#2d3769] text-3xl ">
                      {" "}
                      {arrival?.iataCode}
                    </h3>
                  </div>
              ...
              {/* <p className="text-gray-700 mr-10 mt-4 text-end py-5 text-xl">
